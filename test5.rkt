...
(define tile (sprite (read-bitmap "tile2.png") 0 -37))
(define tile2 (sprite (read-bitmap "tile2x.png") 0 -75));(sprite (read-bitmap "tree.png") 0 -14))
(define tile3 (sprite (read-bitmap "tile4x.png") 0 -148))

(define n1 (get-child-node (get-child-node (get-child-node (create-node) 0) 2) 0))
;(set-payload n1 tile)
;; (define n2 (get-relative-node n1 1 0 0))
;; (set-payload n2 tile)
;; (define n3 (get-relative-node n1 0 1 0))
;; (set-payload n3 tile)
;; (define n4 (get-relative-node n1 0 0 1))
;; (set-payload n4 tile)
(define n5 (get-relative-node n1 0 0 0))
(set-payload n5 tile)
(define nodes null)
;; (for ([i (in-range -5 5)])
;;      (for ([j (in-range -5 5)])
...
;(define side-node2 (get-relative-node (get-parent n1) 0 2 0))
;(set-payload side-node2 tile2)
;; (newline)
;; (get-parent-offset n1 1 (get-parent n1))
(define paren (find-common-parent side-node n1))
(define paren2 (get-parent (get-parent n1)))
(define n3 (get-relative-node paren2 0 -1 0))
(set-payload n3 tile3)
(define n4 (get-relative-node n3 1 0 0))
(set-payload n4 tile3)
